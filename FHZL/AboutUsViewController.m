...
-(void)showRight{
    ...
    _shareView = nil;
    NSDictionary *dict = @{@"shareUrl":[NSString stringWithFormat:@"http://www.ifengstar.com/jump/jump.jsp?project=%@",APPTYPE],@"shareText":[NSString stringWithFormat:@"点击下载%@APP",APPName],@"shareTitle":APPName,@"shareImageUrl":IconImageUrl};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.ScanImageView.image = [UIImage imageNamed:@"fhzl_share.png"];
    return cell;
//   if (indexPath.row == 0) {
