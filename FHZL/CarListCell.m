...
//    if (_isOpen) {
    DISPATCH_ON_MAIN_THREAD((^{
        NSArray *buttonArray = @[@"导航",@"轨迹",@"围栏",@"指令",@"警报",@"详情"];
        NSArray *imageArray = @[@"列表_5_N.png",@"列表_6_N.png",@"列表_7_N.png",@"列表_8_N.png",@"列表_9_N.png",@"列表_10_N.png",];
        NSArray *higthLigthImageArray = @[@"列表_5_P.png",@"列表_6_P.png",@"列表_7_P.png",@"列表_8_P.png",@"列表_9_P.png",@"列表_10_P.png",];
