...
-(id)initWithFrame:(CGRect)frame normalImageStr:(NSString*)normalImageStr seleImageStr:(NSString *)seleImageStr titleStr:(NSString *)titleStr numberStr:(NSString *)numberStr ClickBlock:(void(^)(void))click;
