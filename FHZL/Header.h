...
#define ModifiImage @"120*120.png"
#define IconImageUrl @"https://mmbiz.qlogo.cn/mmbiz_png/I99ib2ZQ2ZxzRpp0VP3UWx30iaeyMM5S9gwATT4f7mcBdhQgvBnHJLkc8fS4cCAbDhLaicqXRCXCmHYoUUnybmxaw/0?wx_fmt=png"
#define BackImageNormal @"标题栏_返回_N.png"
#define BackImageP @"标题栏_返回_P.png"
#define MusicImage @"音乐_专辑显示区域_没有专辑显示.png"
#define appShowVersion @"HKTP1.0.0"
#define baiduKey @"X4x0pSvWy5I3lAKtefFAXBTg1xdmuMWD"
