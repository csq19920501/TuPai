...
-(void)changeEmptyView{
    if (NaviModelArray.count == 0) {
        [_myTablewView addEmptyViewWithImageName:@"" title:@"暂无消息"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"导航" message:@"是否导航到该历史地址" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
