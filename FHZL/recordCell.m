...
-(void)setModel:(recordModel*)model{
    self.dateLabel.text = [NSString stringWithFormat:@"时间:%@",[UserManager getDateDisplayString:[model.dateStr longLongValue]]];
    self.imeiLabel.text = [NSString stringWithFormat:@"IMEI:%@",model.imeiStr];
    self.timeLabel.text = [NSString stringWithFormat:@"%@秒",model.timeStr];;
